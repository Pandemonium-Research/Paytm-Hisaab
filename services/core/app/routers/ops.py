...
add_put(router, area="ops", endpoint="PUT /app/profile", path="/app/profile", request_model=models.AppProfileRequest, response_model=models.AppProfileResponse, query_model=models.AppProfileQuery)
